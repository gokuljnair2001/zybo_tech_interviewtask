...
//
//     final bannerProductsModel = bannerProductsModelFromJson(jsonString);

import 'dart:convert';

BannerProductsModel bannerProductsModelFromJson(String str) => BannerProductsModel.fromJson(json.decode(str));

String bannerProductsModelToJson(BannerProductsModel data) => json.encode(data.toJson());
...
class BannerProductsModel {
    ...
    factory BannerProductsModel.fromJson(Map<String, dynamic> json) => BannerProductsModel(
        id: json["id"],
